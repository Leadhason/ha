                ...
                <svg viewBox="0 0 200 200" className="w-full h-full">
                  <defs>
                    <linearGradient id="grad1" x1="0%" y1="0%" x2="100%" y2="100%">
                      ...
                      <stop offset="50%" style={{ stopColor: "#f0abfc", stopOpacity: 0.6 }} />
                      <stop offset="100%" style={{ stopColor: "#93c5fd", stopOpacity: 0.8 }} />
                    </linearGradient>
                    <linearGradient id="grad2" x1="100%" y1="0%" x2="0%" y2="100%">
                      <stop offset="0%" style={{ stopColor: "#a5f3fc", stopOpacity: 0.7 }} />
                      <stop offset="100%" style={{ stopColor: "#c4b5fd", stopOpacity: 0.9 }} />
                    </linearGradient>
                  </defs>
                  {/* Abstract blob shapes */}
                  <ellipse cx="100" cy="100" rx="80" ry="60" fill="url(#grad1)" transform="rotate(-20 100 100)" />
                  <ellipse cx="120" cy="90" rx="50" ry="70" fill="url(#grad2)" transform="rotate(30 120 90)" opacity="0.7" />
                  <ellipse cx="80" cy="110" rx="40" ry="55" fill="url(#grad1)" transform="rotate(-45 80 110)" opacity="0.5" />
                  {/* Inner highlight */}
                  <ellipse cx="100" cy="95" rx="25" ry="35" fill="white" opacity="0.3" transform="rotate(15 100 95)" />
                </svg>
              </div>
            </div>
          </div>
